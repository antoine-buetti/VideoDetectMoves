...
data <- read.table('data_vid2_frames.dat', header=FALSE)
...
# Create the plot
png('plot_data_vid2_frames.dat.png', width=800, height=600)
...
cat('Plot saved as plot_data_vid2_frames.dat.png\n')
